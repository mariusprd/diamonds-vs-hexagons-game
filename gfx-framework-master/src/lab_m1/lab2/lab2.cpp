...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            // VertexFormat(glm::vec3(3, 0,  0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            // VertexFormat(glm::vec3(0, -2,  0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            // VertexFormat(glm::vec3(0, 0,  3), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
    ...
    //         // VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
    //         // TODO(student): Complete the vertices data for the cube mesh
    //         VertexFormat(glm::vec3(8, 5,  5), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
    //         VertexFormat(glm::vec3(5, 3,  5), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
    //         VertexFormat(glm::vec3(5, 5,  8), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
    //         VertexFormat(glm::vec3(3, 7,  5), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
    //     };
...

    {
        vector<VertexFormat> vertices
        {
            // VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(2, 0,  0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-2, 0,  0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 0,  2), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-2, 0,  2), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
        };
        ...
        // Actually create the mesh from the data
        CreateMesh("sq", vertices, indices);
    }
    ...
    // Create a mesh tetraedru using custom data
    {
        vector<VertexFormat> vertices
        {
            // VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            // colors: 100, 010, 001, 101
            VertexFormat(glm::vec3(8, 5,  5), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5, 3,  5), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5, 5,  8), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 7,  5), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //

            VertexFormat(glm::vec3(8, 5,  5), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5, 3,  5), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //
            VertexFormat(glm::vec3(5, 5,  8), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 7,  5), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(8, 5,  5), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5, 3,  5), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5, 5,  8), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //
            VertexFormat(glm::vec3(3, 7,  5), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
        ...
        meshes["tetraedru_hau"] = new Mesh("generated tetraedru_hau 1");
        meshes["tetraedru_hau"]->InitFromData(vertices, indices);

        // Actually create the mesh from the data
        CreateMesh("tetraedru_hau", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["sq"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.25f));

    // bonnus
    RenderMesh(meshes["tetraedru_hau"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.25f));
